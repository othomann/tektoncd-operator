...
import (
	...
	addonctrl "github.com/tektoncd/operator/pkg/controller/kubernetes/addon"
	pipelinectrl "github.com/tektoncd/operator/pkg/controller/kubernetes/pipeline"
...
func main() {
	...
	log.Info("Registering K8s Components.")
